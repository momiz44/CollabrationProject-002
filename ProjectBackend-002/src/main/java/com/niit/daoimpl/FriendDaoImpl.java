...
public class FriendDaoImpl implements FriendDao {
	...
	public List<User> suggestedUsers(String email) {
		...
		String queryString="select * from user_s201174100025 where email in "
				+ "(select email from user_s201174100025 where email!=? "
				+ "minus "
				+ "(select toId_email from friend_s201174100025 where fromId_email=? "
				+ "union "
				+ "select fromId_email from friend_s201174100025 where toId_email=?))";
